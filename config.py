...
ALIVE_LOGO = getenv("ALIVE_LOGO", "https://graph.org/file/33ed260fcfc79eb82838b.jpg")
ALIVE_TEKS_CUSTOM = getenv("ALIVE_TEKS_CUSTOM", "𝐇ᴇʏ , 𝐀ηѕн 𝐔sᴇʀ𝐁ᴏᴛ 𝐈s 𝐀ʟɪᴠᴇ 🥀")
...
PMPERMIT_PIC = getenv("PMPERMIT_PIC", "https://graph.org/file/33ed260fcfc79eb82838b.jpg")
PM_AUTO_BAN = strtobool(getenv("PM_AUTO_BAN", "True"))
REPO_URL = getenv("REPO_URL", "https://github.com/Anshxxd/USERBOT")
